...
function Button({
  ...
  const variants = {
    ...
    outline:
      'border border-[#5a4631] bg-transparent text-[#f1ddc2] hover:bg-[#151515] hover:text-[#f8f3ec]',
...
function Badge({ children, className = '' }: { children: React.ReactNode; className?: string }) {
  return <div className={`inline-flex items-center rounded-full text-sm ${className}`}>{children}</div>;
}
...
function Input({
  ...
  return <input className={`w-full px-4 outline-none transition-all ${className}`} {...props} />;
}

function ProductCard({ item }: { item: (typeof featured)[number] }) {
  return (
    <motion.div
      ...
      <header className="sticky top-0 z-40 border-b border-[#2a2119] bg-[#090909]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10">
          ...
          <nav className="hidden items-center gap-10 text-sm text-[#c6b9aa] lg:flex">
            <a href="#new" className="transition hover:text-[#f1ddc2]">
              New In
            </a>
            <a href="#shop" className="transition hover:text-[#f1ddc2]">
              Shop
            </a>
            <a href="#collection" className="transition hover:text-[#f1ddc2]">
              Collections
            </a>
            <a href="#stories" className="transition hover:text-[#f1ddc2]">
              Maison Story
            </a>
          </nav>
          <div className="flex items-center gap-3">
            <button className="rounded-full border border-[#3b2f24] bg-[#121212] p-2">
              <Search className="h-4 w-4 text-[#f1ddc2]" />
            </button>
            <button className="rounded-full border border-[#3b2f24] bg-[#121212] p-2">
              <ShoppingBag className="h-4 w-4 text-[#f1ddc2]" />
            </button>
          </div>
        </div>
      </header>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-12 lg:grid-cols-[1.02fr_0.98fr] lg:px-10 lg:py-20">
        ...
        >
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-[#b7a998]">
            Discover refined silhouettes, rich textures, and statement pieces designed for women who
            want bold elegance with a premium finish.
          </p>
          ...
          <div className="mt-12 grid max-w-2xl grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-[1.5rem] border border-[#2c231b] bg-[#111111] p-4 shadow-sm">
              <div className="flex items-center gap-2 text-sm text-[#b7a998]">
                <RefreshCw className="h-4 w-4" /> Seamless returns
              </div>
              <div className="mt-2 text-sm font-medium text-[#f8f3ec]">Easy 7-day return window</div>
            </div>
            <div className="rounded-[1.5rem] border border-[#2c231b] bg-[#111111] p-4 shadow-sm">
              <div className="flex items-center gap-2 text-sm text-[#b7a998]">
                <ShieldCheck className="h-4 w-4" /> Trusted checkout
              </div>
          ...
          <Card className="absolute -bottom-8 left-8 max-w-sm rounded-[2rem] border border-[#3a2f24] bg-[#111111]/95 shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
            <CardContent className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-[#b7a998]">
                Meticulous fabrics, flattering cuts, and a visual identity inspired by high-fashion
                night editorials.
              </p>
            </CardContent>
          </Card>
      ...
      <section id="collection" className="mx-auto max-w-7xl px-6 py-12 lg:px-10">
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-semibold text-[#f8f3ec] lg:text-5xl">
              A premium wardrobe, reimagined in noir
            </h2>
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
          <Card className="overflow-hidden rounded-[2.5rem] border border-[#2d241c] bg-[linear-gradient(135deg,rgba(17,17,17,0.95),rgba(28,22,18,0.98))] shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
            <CardContent className="p-8 lg:p-12">
              ...
              <h3 className="mt-4 max-w-xl text-3xl font-semibold leading-tight text-[#f8f3ec] lg:text-5xl">
                Crafted for confidence, polish, and dark luxury.
              </h3>
              <p className="mt-6 max-w-2xl text-base leading-8 text-[#b7a998]">
                AURELLE is designed for women who prefer refined dressing over excess. Every piece is
                imagined with sculpted structure, graceful movement, and a luxurious finish that feels
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {testimonials.map((item) => (
              <Card
                key={item.name}
                className="rounded-[2rem] border border-[#2c231b] bg-[#101010] shadow-[0_16px_40px_rgba(0,0,0,0.3)]"
              >
                <CardContent className="p-6">
        ...
        <Card className="overflow-hidden rounded-[2.5rem] border border-[#3a2d22] bg-[linear-gradient(135deg,#0b0b0b,#15110d,#261d15)] text-white shadow-[0_30px_100px_rgba(0,0,0,0.5)]">
          <CardContent className="relative p-8 text-center lg:p-14">
            ...
            <div className="relative">
              ...
              <h3 className="mt-3 text-3xl font-semibold lg:text-5xl">
                Receive first access to new drops and exclusive releases.
              </h3>
              <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-[#d5c6b5]/78">
                Join the AURELLE list for early access, private offers, seasonal edits, and style
                inspiration curated with a dark luxury lens.
              </p>
              <div className="mx-auto mt-8 flex max-w-xl flex-col gap-3 sm:flex-row">
                <Input
                  placeholder="Enter your email"
                  className="h-12 rounded-2xl border border-[#3d3125] bg-[#121212] text-[#f8f3ec] placeholder:text-[#8f7f6e]"
                />
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-6 py-12 lg:grid-cols-4 lg:px-10">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3 text-[#b7a998]">
              <button className="rounded-full border border-[#3b2f24] bg-[#111111] p-2">
